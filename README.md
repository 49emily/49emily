...
- Taking a graduate-level blockchain engineering and theory class (EE374) with Dionysis Zindros.
- Attending entrepreneurship workshops and speaker series with VCs and founders to develop a minimally viable product and pitch to VCs as a Stanford ASES Bootcamp fellow.

### 👩🏻‍💻 Previously, I...
- Worked as a Software Developement Intern for AquaRealTime, a Boulder-based startup building low-cost algae trackers. I built graph annotation features in Vue.js for the client site and got super passionate about ecotechnology while doing it.
